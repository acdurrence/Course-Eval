<?php include 'admin_tools/data_accessor.php'; 
    $course_id = $_REQUEST["id"];  //grab inputs
    ?>
<html lang="en"> 
    <head> 
        <meta charset="utf-8"> 
    ...
    <body> 
        ...
        <div class="main"> 
            <div class="leftdiv">
                ...
                <table>
                    ...
                    <tr>
                        <?php $courseinfo = getCourseInfo($course_id);
                        $evalinfo = getEvalInfo($course_id);
                        $inst_info = getInstructorInfo($course_id)?>
                        <td class="td2_B"><?php echo $evalinfo["Term"];?></td>
                        <td class="td1_B"><?php echo $courseinfo["Title"];?></td>
                        <td class="td2_B"><?php echo $courseinfo["Number"];?></td>
                        <td class="td3_B">
                            <a href="page_faculty.html"><?php echo $inst_info["Name"];?></a>
                        </td>
                    </tr>
                </table>
                ...
                <ul>
                    ...
                    <li>The course content (assignments, readings, lectures, etc.)
                        ...
                        instructor </li>
                        <?php
                        $data = getRatingFromCID($course_id);
        ...
        ?>
            ...
            <div class="second"> 
                <!--Second-->                 
                <ul class="tabs">
                    <li class="tab" data-tab="tab-1"><?php echo $evalinfo["Term"];?></li>
        ...
        chart.draw(data, options);
            ...
            <div class="bottom">
                <table cellspacing='0'> 
                    ...
                    <tr class='even'>
                        <td><?php echo $evalinfo["Term"];?></td>
                        <td><?php echo $evalinfo["Total"];?></td>
                        <td><?php echo $evalinfo["Sample"];?></td>
                    </tr>
                    <!-- Darker Table Row -->
                </table>
            </div>
